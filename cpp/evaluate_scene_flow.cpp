...
bool eval (string result_sha,Mail* mail) {
  ...
  std::cout<<result_disp_0_dir<<std::endl;
  ...
  for (int32_t i=0; i<NUM_TEST_IMAGES; i++) {
    ...
    try {
      ...
      if (eval_disp) {
        ...
        std::cout<<"===================================="<<std::endl;
        std::cout<<D_gt_noc_0.width()<<" ,"<<D_gt_noc_0.height()<<std::endl;
...
int32_t main (int32_t argc,char *argv[]) {
  ...
  mail->msg("Thank you for participating in our evaluak you for participating in our evaluation!");
